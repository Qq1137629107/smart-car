...
// LCD12864
#define CS   P04 // LCD片选信号
#define RST  P03 // LCD复位信号
#define RS   P02 // LCD寄存器选择信号
#define SDA  P01 // LCD数据信号
#define SCK  P00 // LCD时钟信号
#define LEDA P46 // LCD背光信号
...
#define SCK1             P21 // 主机输出，串行时钟引脚（输出）
